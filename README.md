...
| OS | Download | Format |
| --- | --- | --- |
| **Windows** | [OpenGit_x64-setup.exe](https://github.com/rldona/OpenGit/releases/download/v0.3.0/OpenGit_0.3.0_x64-setup.exe) · [OpenGit_x64.msi](https://github.com/rldona/OpenGit/releases/download/v0.3.0/OpenGit_0.3.0_x64_en-US.msi) | Installer / MSI |
| **macOS** (Apple Silicon) | [OpenGit_aarch64.dmg](https://github.com/rldona/OpenGit/releases/download/v0.3.0/OpenGit_0.3.0_aarch64.dmg) | DMG |
| **Linux** | [OpenGit_amd64.deb](https://github.com/rldona/OpenGit/releases/download/v0.3.0/OpenGit_0.3.0_amd64.deb) · [OpenGit_amd64.AppImage](https://github.com/rldona/OpenGit/releases/download/v0.3.0/OpenGit_0.3.0_amd64.AppImage) | Debian / AppImage |
